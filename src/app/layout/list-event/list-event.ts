...
export class ListEvent {
  events: Event[] = [
    ...
    },
    {
      ...
      description: 'Hands-on workshop about modern frontend tooling and patterns.',
    ...
    },
    {
      ...
      description: 'Sessions about cloud native architectures and best practices.',
